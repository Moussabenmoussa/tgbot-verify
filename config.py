...
CHANNEL_USERNAME = os.getenv("CHANNEL_USERNAME", "golbakmon")
CHANNEL_URL = os.getenv("CHANNEL_URL", "https://t.me/golbakmon")

# 管理员配置
ADMIN_USER_ID = int(os.getenv("ADMIN_USER_ID", "1413638026"))
